...
$csvFile = fopen('./files/ANMA_2022BILL_SMSBLAST_FINAL_RESIDENTIAL.csv', 'r');
...
$assembly_abbrv = "ANMA";
$bill_type = "Residential Property Rate";
$year = "2022";
$phone_no1 = "0541214224";
$phone_no2 = "0551500055";
...
while(($line = fgetcsv($csvFile)) !== FALSE){
    if($line[4] == "NULL"){
        ...
        $msg = new AMQPMessage(
            ...
            json_encode(array('message' => "Dear Customer \nGreetings from ".$assembly.".\nYour ".$year." ".$bill_type." Bill for ". $line[2]." is Ghs".number_format((float)$line[4], 0, '.', '').", Arrears is Ghs".number_format((float)$line[5], 0, '.', '')."\nTotal Bill is GHs".number_format((float)$line[6], 0, '.', '').".\nPlz pay at any nearest ".$assembly_abbrv." office, Paypoint or collector. Insist on your receipt for any payment. Plz call ".$phone_no1." or ".$phone_no2." if you have any issue or if your bill has been paid already for the necessary corrections to be made on your account.\nThank U", "number" => $line[0])),
